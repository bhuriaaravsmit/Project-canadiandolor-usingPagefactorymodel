package com.canadiandollor.customlisteners;
...
import static com.canadiandollor.utility.Utility.takeScreenShot;
...
public class CustomListeners implements ITestListener {
    ...
    public void onStart(ITestContext iTestContext) {
        ...
        reporter.config().setReportName("CanadianDollor Bingo");
